...
adminRoutes.post("/", authMiddleware, roleMiddleware(["SuperAdmin","Admin"]), createAdmin);
...
adminRoutes.delete("/:id", authMiddleware, roleMiddleware(["SuperAdmin","Admin"]), deleteAdmin);
